    ...
    <div class="section section-padding top-padding-normal news-section" >
        ...
        <div class="container" style="margin-top: 100px; padding: 0px;">
            <div class="single-section video-entry">
                <h3 class="single-section-title">매점 안내</h3>
                <div class="section-content" style="margin-top: 50px;" >
                    <div id="single-gallery-1" class="owl-carousel single-gallery-slider" >
                        <img class="img-responsive" src="images/slider/snack1.png" width="100%" alt="Slider Image">
                        <img class="img-responsive" src="images/slider/snack2.png" width="100%" alt="Slider Image">
                        <img class="img-responsive" src="images/slider/snack3.png" width="100%" alt="Slider Image">
                        <img class="img-responsive" src="images/slider/snack4.png" width="100%" alt="Single Slider Image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container" style="margin-top: 20px;">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <a class="news-featured" style="margin-top: 40px" href="https://pf.kakao.com/_lxidMu/30753728" target="_blank">
                        <img class="img-responsive" src="{{asset('images/slider/snack.png')}}" style="border-radius: 15px; " width="555px" height="200px" alt="Featured news thumb">
                        <div class="">
                        </div>
                    </a>
                </div>
               ...
               <div class="row">
                <div class="col-xs-12">
                    <a class="news-featured" style="margin-top: 40px" href="https://pf.kakao.com/_lxidMu/30753728" target="_blank">
                        <img class="img-responsive " src="{{asset('images/slider/order.png')}}" style="border-radius: 15px; width: 50%; margin-left: auto; margin-right: auto;" alt="Featured news thumb">
                        <div class="">
                        </div>
                    </a>
                </div>
